...
var profile = {
	...
	packages:[{
	            name: "dojo",
	            location: "../../dojo/1.7.3/dojo"
	        },{
	            name: "dijit",
	            location: "../../dojo/1.7.3/dijit"
	        },{
	            name: "app",
	            location: "app"
        }],
	...
	layers: {
		...
		'dojo/dojo': {
			...
			exclude: ['app/common/widgets/UserManagementWidget/UserManagementWidget'],
		...
		'app/app': { 
		            include: ['app/common/widgets/UserManagementWidget/UserManagementWidget', 'dojo/i18n'] 
        	}
